...
%{SOURCE26} supported-gpus/supported-gpus.json pci_ids-%version
%{SOURCE26} supported-gpus/supported-gpus.json --skip-legacy pci_ids-%version.new
# supplements no longer depend on the driver
%if (0%{?sle_version} >= 150400 || 0%{?suse_version} >= 1550)
%define pci_id_file pci_ids-%version
%else
%define pci_id_file pci_ids-%version.new
%endif
